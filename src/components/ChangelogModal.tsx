...
const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: "August 2026",
    changes: [
      { type: "new", text: "Ai Helper — answers to your questions" },
      { type: "new", text: "Get help" },
      { type: "new", text: "Install it locally on your device" },
      { type: "new", text: "Choose your own location for the weather" },
      { type: "new", text: "choose what type of notificication  to get" },
      { type: "improved", text: "Loading state🔃" },
      { type: "improved", text: "Keyboard shortcuts" },
      { type: "improved", text: "Management" },
    ],
  },
];
